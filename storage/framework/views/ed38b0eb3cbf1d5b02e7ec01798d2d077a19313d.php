    ...
    <div class="nav-right col pull-right right-menu p-0">
      <ul class="nav-menus">
        ...
        <li class="onhover-dropdown p-0">
          <a class="btn btn-primary-light" type="button" href="<?php echo e(route('logout')); ?>"><i data-feather="log-out"></i>Log out</a>
        </li>
      </ul>
    </div>
...
<?php /**PATH F:\Clients\2021-10\Richard\runcapitalgroup\resources\views/layouts/admin/partials/header.blade.php ENDPATH**/ ?>